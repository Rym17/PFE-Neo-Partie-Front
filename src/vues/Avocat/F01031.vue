                ...
                >
                  <v-row class="mt-2 mx-3">
                    <v-col cols="12" md="12">
                      ...
                      >
                        ...
                        <v-tab :key="1">{{
                          $t("F01021.expansion-panels.ep0101")
                        }}</v-tab>
                        <v-tab :key="2">{{
                          $t("F01021.expansion-panels.ep0102")
                        }}</v-tab>
                      </v-tabs></v-col
                    >
                  </v-row>
                  ...
                  <v-tabs-items v-model="tab">
                    <v-tab-item :key="1" class="tab">
                      <TD_JS_CONVOCATIONS
                        @getDataTable="TD_JS_CONVOCATIONS_update"
                        :initValue="notice.TD_JS_CONVOCATIONS.row"
...
import TD_JS_CONVOCATIONS from "../../datatables/TD_JS_CONVOCATIONS.vue";
...
export default {
  ...
  methods: {
    ...
    TD_JS_CONVOCATIONS_update(DataTable) {
      this.notice.TD_JS_CONVOCATIONS.row = DataTable.data;
      console.log(
        "updateDataTable | TD_JS_CONVOCATIONS : ",
        this.notice.TD_JS_CONVOCATIONS.row
      );
    },
    ...
    async GeData() {
      ...
      if (getJsonFromSPResponse.Success == "true") {
        ...
        this.DataTable04_c05_ITEMS = getJsonFromSPResponse.Result;
      }
    ...
    async saveTraceNotice(chrono, success, message) {
      ...
      this.trace.c02 = "الاستدعاءات و المؤيدات";
