                ...
                >
                  <v-row class="mt-2 mx-3">
                    <v-col cols="12" md="12">
                      ...
                      >
                        ...
                        <v-tab :key="1">{{
                          $t("F01035.expansion-panels.ep0101")
                        }}</v-tab>
                        <v-tab :key="2">{{
                          $t("F01035.expansion-panels.ep0102")
                        }}</v-tab>
                        <v-tab :key="3">{{
                          $t("F01035.expansion-panels.ep0103")
                        }}</v-tab>
                        <v-tab :key="4">{{
                          $t("F01035.expansion-panels.ep0104")
                        }}</v-tab>
                      </v-tabs></v-col
                    >
                  </v-row>
                  <v-tabs-items v-model="tab">
                    <v-tab-item :key="1" class="tab">
                      ...
                      <v-row class="mt-2 mx-3"
                        ><v-col cols="12" md="6"
                          ><neo-date-picker
                            locale="ar-TN"
                            v-bind:label="
                              $t('F01035.Fields.CF_JS_DATE_RAPPORT')
                            "
                            v-model="notice.data.CF_JS_DATE_RAPPORT"
                          />
                        </v-col>
                        ...
                        <v-col cols="12" md="6"
                          ><neo-date-picker
                            locale="ar-TN"
                            v-bind:label="
                              $t('F01035.Fields.CF_JS_DATE_AUDIENCE')
                            "
                      ...
                      <v-row class="mt-2 mx-3">
                        <v-col cols="12" md="12">
                          <neo-text-field
                            v-bind:label="
                              $t('F01035.Fields.CF_JS_TITRE_RAPPORT')
                            "
                            v-model="notice.data.CF_JS_TITRE_RAPPORT"
                          />
                        </v-col>
                      </v-row>
                      <v-row class="mt-2 mx-3">
                    ...
                    <v-tab-item :key="4" class="tab">
                      <TD_JS_JUSTIFICATIF_RAPPORT
                        @getDataTable="TD_JS_JUSTIFICATIF_RAPPORT_update"
                        :initValue="notice.TD_JS_JUSTIFICATIF_RAPPORT.row"
                        :AttachmenListFile="AttachmenListFileFiltred"
                      ></TD_JS_JUSTIFICATIF_RAPPORT>
                      <v-row class="mt-2 mx-3">
                        <v-col cols="12" md="12"> </v-col>
                      </v-row>
...
import TD_JS_JUSTIFICATIF_RAPPORT from "../../datatables/TD_JS_JUSTIFICATIF.vue";
export default {
  name: "F01035",
  components: {
    TD_JS_ARGUMENTS,
  ...
  methods: {
    ...
    TD_JS_JUSTIFICATIF_RAPPORT_update(DataTable) {
      this.notice.TD_JS_JUSTIFICATIF_RAPPORT.row = DataTable.data;
      console.log(
        "updateDataTable | TD_JS_JUSTIFICATIF_RAPPORT : ",
        this.notice.TD_JS_JUSTIFICATIF_RAPPORT.row
      );
    },
    ...
    async saveNotice() {
      ...
      this.notice.mapping.SP_SUBJECT = "تقرير محامي";
      this.notice.data.CF_JS_DATE_AUDIENCE = this.SaveformatDate(
        this.notice.data.CF_JS_DATE_AUDIENCE
      );
      this.notice.data.CF_JS_DATE_RAPPORT = this.SaveformatDate(
        this.notice.data.CF_JS_DATE_RAPPORT
      );
      this.notice.data.CF_JS_DATE_DEPOT_REQUETE = this.SaveformatDate(
        this.notice.data.CF_JS_DATE_DEPOT_REQUETE
      );
