...
export default {
  ...
  methods: {
    DataTable_Select() {
      console.log("DataTable01_Select | selected ", this.DataTable01.selected);
      if (this.DataTable01.selected[0] != undefined) {
        this.searchResult = this.DataTable01.selected[0];
        this.dialog = false;
      }
      bus.$emit("SetSearchObject3", this.searchResult);
    },
    searchItems() {
      var data = this.DataTable01.data.filter(
        (word) =>
      ...
      console.log("searchItems | DataTable01", this.DataTable01);
    },
    DisplaySearch() {
      this.dialog = true;
  ...
  mounted() {
    this._DataTable01 = this.DataTable01;
    console.log("neosearchfield | mounted | DataTable01 : ", this.DataTable01);
  },
};
</script>
