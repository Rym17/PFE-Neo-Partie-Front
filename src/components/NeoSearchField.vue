      ...
      <v-card outlined>
        <v-card-text>
          <v-row class="mx-2 mt-5">
            ...
            <v-col cols="12" sm="2" md="2" lg="2">
              <neo-text-field
                label="الدائرة القضائية الاستئنافية"
                ref="recherche"
            ...
            <v-col cols="12" sm="2" md="2" lg="2">
              <neo-text-field
                label="الدائرة القضائية الابتدائية"
                ref="recherche"
...
export default {
    ...
    return {
      ...
      DataTable: {
        Headers: [
          ...
          {
            text: "الدائرة القضائية الاستئنافية",
            value: "c04",
            width: "100px",
            sortable: false,
            align: "center",
          ...
          {
            text: "الدائرة القضائية الابتدائية",
            value: "c05",
            width: "300px",
            sortable: false,
            align: "center",
  ...
  methods: {
    DataTable_Select() {
      ...
      this.DataTable.data = this.DataTable.dataInit;
      bus.$emit("SetSearchObject1", this.searchResult);
    },
    searchItems() {
      var data = this.DataTable.dataInit.filter(
        (word) =>
          word.c02 == this.filters.search1 &&
          word.c03 == this.filters.search2 &&
          word.c04 == this.filters.search3 &&
          word.c05 == this.filters.search4 &&
          word.c06 == this.filters.search5 &&
          word.c07 == this.filters.search6
      );
      this.DataTable.data = data;
      console.log("searchItems | DataTable", this.DataTable.data);
    },
    DisplaySearch() {
